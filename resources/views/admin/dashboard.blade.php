                ...
                <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden hover:scale-[1.02] transition-all duration-300 group">
                    <div class="p-8">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 font-medium mt-1 uppercase">Proyek menunggu verifikasi</p>
                        </div>
                        <div class="mt-8">
                ...
                <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden hover:scale-[1.02] transition-all duration-300 group">
                    <div class="p-8">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 font-medium mt-1 uppercase">Website yang sedang live</p>
                        </div>
                        <div class="mt-8">
                ...
                <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden hover:scale-[1.02] transition-all duration-300 group">
                    <div class="p-8">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 font-medium mt-1 uppercase">User yang terdaftar</p>
                        </div>
                        <div class="mt-8">
